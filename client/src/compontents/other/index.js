...
return (<div className="options">
        ...
        <Popover _hover={{}} _focus={{}} _active={{}} matchWidth={true}>
            <PopoverTrigger >
                {Object.keys(user).length>0?<Avatar style={{cursor:'pointer'}} name={user.firstname + ' '+ user.lastname} src={user.userAvatar} />:<Avatar bg={colors.background} style={{cursor:'pointer'}} />}
            </PopoverTrigger>
