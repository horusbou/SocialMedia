...
useEffect(()=>{
  ...
  return (
    ...
    <div className="avatar">
        <Avatar name={`${userData.firstName} ${userData.lastName}`} size="2xl" src={userData.userAvatar}/>
    </div>
    ...
    {isLoading?<div className="spinner"><Spinner thickness="4px" speed="0.65s" emptyColor="gray.200" color="blue.500" size="md" /></div>:(
      <>
      {!!profilePosts ?
    ...
    (<Flex mt="20px" justify="center" align="center">
      <Box className="content">
        ...
        <Text className="subHeading" color="gray.500">Try searching for another.</Text>
      </Box>
      </Flex>)
      :null}
        </>
